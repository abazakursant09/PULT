"""Rating / Reputation Health Diagnosis contour data foundation (Phase 5.0) — rating_signal + rating_audit
...
signal keyed by insight_key `rating_<problem_type>:<marketplace>:<sku>` carrying the five
...
wired to nothing. Distinct from the Review contour; does NOT reuse review_signal.

Revision ID: rat1a2b3c4d01
Revises: sup1a2b3c4d01
...
revision: str = "rat1a2b3c4d01"
down_revision: Union[str, None] = "sup1a2b3c4d01"
...
def upgrade() -> None:
    ...
    op.create_index("ix_rating_audit_user_listing", "rating_audit", ["user_id", "listing_id"])
    op.create_index("ix_rating_audit_status", "rating_audit", ["status"])
    ...
    op.create_index("ix_rating_signal_user_listing", "rating_signal", ["user_id", "listing_id"])
    op.create_index("ix_rating_signal_insight", "rating_signal", ["insight_key"])
    op.create_index("ix_rating_signal_audit", "rating_signal", ["audit_id"])
    op.create_index("ix_rating_signal_status", "rating_signal", ["status"])
    op.create_index("ix_rating_signal_category", "rating_signal", ["category"])


def downgrade() -> None:
    op.drop_index("ix_rating_signal_category", table_name="rating_signal")
    op.drop_index("ix_rating_signal_status", table_name="rating_signal")
    op.drop_index("ix_rating_signal_audit", table_name="rating_signal")
    op.drop_index("ix_rating_signal_insight", table_name="rating_signal")
    op.drop_index("ix_rating_signal_user_listing", table_name="rating_signal")
    op.drop_table("rating_signal")

    op.drop_index("ix_rating_audit_status", table_name="rating_audit")
    op.drop_index("ix_rating_audit_user_listing", table_name="rating_audit")
