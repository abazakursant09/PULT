...
# Stock/listing type (stop_auto_promotion, offer_id-derivable) exercises the bridge's
# apply hand-off. Overspend types now bind ad_set_state (campaign pause) and are
# covered by the A2.2-bind tests with a campaign resolver.
