...
def test_all_pricing_signals_bind_set_price():
    # A3: floor, A4: break-even, A4-margin-target: cost-plus — all three → set_price.
    for t in ("pricing_price_below_floor", "pricing_negative_margin",
