...
const FAQ = [
  {
    q: 'Как загрузить данные в Бизнес-Пульт?',
    a: 'Бизнес-Пульт ставит диагноз по вашим отчётам с маркетплейса. Выгрузите отчёт (по продажам, товарам или возвратам) из кабинета Wildberries, Ozon или Яндекс Маркета и загрузите его в разделе «Импорт данных» — API-ключи не нужны. Диагноз появится на главной автоматически.',
  },
  {
              ...
              <Card className="shadow-stripe overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    {['Начало работы с платформой', 'Импорт отчётов из маркетплейса', 'Настройка уведомлений', 'Экспорт отчётов'].map(title => (
