...
const FAQ = [
  {
    q: 'Как подключить свой магазин к Пульту?',
    a: 'Сейчас Пульт работает в демо-режиме с тестовыми данными. Подключение через API маркетплейсов (Wildberries, Ozon, Яндекс Маркет) появится в ближайших обновлениях. Следите за уведомлениями в личном кабинете.',
  },
  {
